...
# ===== CREATE tests ======
def test_create_care_centre_success(get_db_session_mock, mock_current_user,
    ...
    assert result.created_by_id == mock_current_user["id"]


def test_create_care_centre_duplicate_fail(get_db_session_mock, mock_current_user,
...
#===== UPDATE tests ======
def test_update_care_centre_success(get_db_session_mock, mock_current_user, 
    ...
    assert result.modified_by_id == mock_current_user["id"]
    assert result.modified_date is not None

def test_update_care_centre_not_found_fail(get_db_session_mock, mock_current_user, update_care_centre_schema):
    """ Raises HTTPException when Care Centre not found """
...
def test_update_care_centre_duplicate_fail(get_db_session_mock, mock_current_user, 
                                           update_care_centre_schema, existing_care_centre):
    """ Raises HTTPException when duplicate Care Centre exists """
...
# ====== DELETE tests ======
def test_delete_care_centre_success(get_db_session_mock, mock_current_user, existing_care_centre):
...
def test_delete_care_centre_not_found_fail(get_db_session_mock, mock_current_user):
    """ Raises HTTPException when Care Centre not found """
