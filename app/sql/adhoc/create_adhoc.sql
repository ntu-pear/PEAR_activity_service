...
CREATE TABLE [dbo].[ADHOC] (
    ...
    old_centre_activity_id     INT             NOT NULL CONSTRAINT fk_adhoc_old_centre_activity FOREIGN KEY REFERENCES [dbo].[CENTRE_ACTIVITY](id),
    new_centre_activity_id     INT             NOT NULL CONSTRAINT fk_adhoc_new_centre_activity FOREIGN KEY REFERENCES [dbo].[CENTRE_ACTIVITY](id),
