...
class CentreActivityAvailabilityBase(BaseModel):
    ...
    is_deleted: bool = Field(..., description="Indicates whether the record is soft-deleted.")
    start_time: date = Field(..., description="Specific Date and Start time of the Centre Activity Availability.")
    end_time: date = Field(..., description="Specific Date and End time of the Centre Activity Availability. Must be same date as start_date.")
