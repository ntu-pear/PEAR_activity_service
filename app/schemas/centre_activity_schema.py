...
class CentreActivityBase(BaseModel):
    ...
    min_duration: int = Field(60, description="Minimum duration in minutes", ge=60, le=60)
    max_duration: int = Field(60, description="Maximum duration in minutes", ge=60, le=60)
